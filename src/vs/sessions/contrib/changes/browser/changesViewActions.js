...
class OpenPullRequestAction extends Action2 {
  static {
    this.ID = "workbench.action.agentSessions.openPullRequest";
  }
  constructor() {
    super({
...
class SetChangesListViewModeAction extends Action2 {
  static {
    this.ID = "workbench.action.agentSessions.setChangesListViewMode";
  }
  constructor() {
    super({
...
class SetChangesTreeViewModeAction extends Action2 {
  static {
    this.ID = "workbench.action.agentSessions.setChangesTreeViewMode";
  }
  constructor() {
    super({
...
class CollapseAllSessionChangesDiffsAction extends Action2 {
  static {
    this.ID = "workbench.action.agentSessions.collapseAllDiffs";
  }
  constructor() {
    super({
...
class ExpandAllSessionChangesDiffsAction extends Action2 {
  static {
    this.ID = "workbench.action.agentSessions.expandAllDiffs";
  }
  constructor() {
    super({
...
class OpenChangesAction extends Action2 {
  static {
    this.ID = "workbench.action.agentSessions.openChanges";
  }
  constructor() {
    super({
...
class OpenFileAction extends Action2 {
  static {
    this.ID = "workbench.action.agentSessions.openFile";
  }
  constructor() {
    super({
