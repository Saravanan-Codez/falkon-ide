...
let TitleBarAccountWidget = class extends BaseActionViewItem {
  constructor(action, options, defaultAccountService, authenticationService, menuService, contextKeyService, hoverService, instantiationService, chatEntitlementService, codexAccountService, sessionsManagementService, configurationService, commandService) {
