...
let BrowserEmulationToolbar = class extends Disposable {
  ...
  static {
    this.ZOOM_PRESETS = [0.5, 0.75, 1, 1.25, 1.5, 2];
  }
  static {
    this.AUTO_INDEX = 0;
  }
...
class ToggleBrowserEmulationAction extends Action2 {
  static {
    this.ID = "workbench.action.browser.toggleDeviceEmulation";
  }
  constructor() {
    super({
...
class ToggleBrowserMobileEmulationAction extends Action2 {
  static {
    this.ID = "workbench.action.browser.toggleMobileEmulation";
  }
  constructor() {
    super({
...
class PickBrowserDevicePresetAction extends Action2 {
  static {
    this.ID = "workbench.action.browser.pickDevicePreset";
  }
  constructor() {
    super({
...
class SetBrowserUserAgentAction extends Action2 {
  static {
    this.ID = "workbench.action.browser.setUserAgent";
  }
  constructor() {
    super({
...
class ResetBrowserEmulationAction extends Action2 {
  static {
    this.ID = "workbench.action.browser.resetEmulation";
  }
  constructor() {
    super({
