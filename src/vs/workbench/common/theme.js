...
const TAB_SELECTED_BORDER_TOP = registerColor("tab.selectedBorderTop", {
  dark: focusBorder,
  light: focusBorder,
...
const TAB_SELECTED_BACKGROUND = registerColor("tab.selectedBackground", listInactiveSelectionBackground, localize("tabSelectedBackground", "Background of a selected tab. Tabs are the containers for editors in the editor area. Multiple tabs can be opened in one editor group. There can be multiple editor groups."));
...
const SURFACE_BACKGROUND = registerColor("surface.background", {
...
const SURFACE_FOREGROUND = registerColor("surface.foreground", SIDE_BAR_FOREGROUND, localize("surfaceForeground", 'Foreground color of framed container surfaces ("cards"), such as the floating workbench panels in the modern layout.'));
const SURFACE_BORDER = registerColor("surface.border", {
