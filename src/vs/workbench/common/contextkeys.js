...
const IsSessionsWindowContext = new RawContextKey("isSessionsWindow", false, localize("isSessionsWindow", "Whether the current window is a agent sessions window."));
...
const ActiveEditorCannotCloseContext = new RawContextKey("activeEditorCannotClose", false, localize("activeEditorCannotClose", "Whether the active editor cannot be closed through standard user actions"));
...
const ActiveCustomEditorDiffCanToggleLayoutContext = new RawContextKey("activeCustomEditorDiffCanToggleLayout", false, localize("activeCustomEditorDiffCanToggleLayout", "Whether the active custom editor diff can toggle between inline and side by side layout"));
const ActiveCustomEditorTextDiffContext = new RawContextKey("activeCustomEditorTextDiff", false, localize("activeCustomEditorTextDiff", "Whether the active custom editor diff is backed by text documents"));
...
const IsTopRightEditorGroupContext = new RawContextKey("isTopRightEditorGroup", false, localize("isTopRightEditorGroup", "Whether the editor group is the top right editor group in the editor part"));
...
const EditorPartModalVisibleContext = new RawContextKey("editorPartModalVisible", false, localize("editorPartModalVisible", "Whether a modal editor part is visible"));
...
const EditorPartModalSidebarContext = new RawContextKey("editorPartModalSidebar", false, localize("editorPartModalSidebar", "Whether the modal editor part has a sidebar"));
const EditorPartModalSidebarVisibleContext = new RawContextKey("editorPartModalSidebarVisible", false, localize("editorPartModalSidebarVisible", "Whether the modal editor part sidebar is visible"));
const EditorsVisibleContext = new RawContextKey("editorIsOpen", false, localize("editorIsOpen", "Whether an editor is open"));
const EditorAreaFocusContext = new RawContextKey("editorAreaFocus", false, localize("editorAreaFocus", "Whether the editor area (any editor part) has keyboard focus"));
...
const SecondarySideBarVisibleContext = new RawContextKey("secondarySideBarVisible", false, localize("secondarySideBarVisible", "Whether the layout surface representing the secondary side bar is visible"));
...
let AbstractResourceContextKey = class {
...
AbstractResourceContextKey = __decorateClass([
  __decorateParam(0, IContextKeyService),
  __decorateParam(1, IFileService),
  __decorateParam(2, ILanguageService),
  __decorateParam(3, IModelService)
], AbstractResourceContextKey);
let ResourceContextKey = class extends AbstractResourceContextKey {
...
export {
  ...
  RemoteNameContext,
  ResourceContextKey,
  SecondarySideBarVisibleContext,
