...
Registry.as(WorkbenchExtensions.Workbench).registerWorkbenchContribution(TauriTerminalContribution, LifecyclePhase.Restored);
...
import { create, commands, logger, env, window, workspace } from "./browser/web.factory.js";
export {
  commands,
  create,
  env,
