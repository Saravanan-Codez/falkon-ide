...
let BrowserEditorChatIntegration = class extends BrowserEditorContribution {
  ...
  static {
    this.SHARING_CONTENT_WARNING_DONT_ASK_KEY = "browserView.agentSharingContentWarning.dontAskAgain";
  }
  /**
...
class AddElementCommentToChatAction extends Action2 {
  static {
    this.ID = BrowserViewCommandId.AddElementCommentToChat;
  }
  constructor() {
    super({
...
class AddScreenshotToChatAction extends Action2 {
  static {
    this.ID = BrowserViewCommandId.AddScreenshotToChat;
  }
  constructor() {
    super({
...
class AddAreaScreenshotToChatAction extends Action2 {
  static {
    this.ID = BrowserViewCommandId.AddAreaScreenshotToChat;
  }
  constructor() {
    super({
...
class AddFullPageScreenshotToChatAction extends Action2 {
  static {
    this.ID = BrowserViewCommandId.AddFullPageScreenshotToChat;
  }
  constructor() {
