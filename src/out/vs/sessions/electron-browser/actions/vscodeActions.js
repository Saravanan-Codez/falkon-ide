...
class OpenSessionInVSCodeAction extends Action2 {
  static {
    this.ID = "agents.openSessionInVSCode";
  }
  constructor() {
    super({
...
class OpenVSCodeWindowAction extends Action2 {
  static {
    this.ID = OPEN_VSCODE_WINDOW_COMMAND_ID;
  }
  constructor() {
    super({
